<script>
    ...
    $pageTitle = "备份";  // Changed from "Backups";
    ...
    async function save() {
        ...
        try {
            ...
            addSuccessToast("应用设置保存成功。");  // Changed from "Successfully saved application settings."
        } catch (err) {
            ApiClient.error(err);
        }
                            ...
                            <div class="grid p-t-base p-b-sm">
                                        ...
                                        <div class="form-field-addon">
                                            <button type="button" class="btn btn-sm btn-outline p-r-0">
                                                ...
                                                <Toggler class="dropdown dropdown-nowrap dropdown-right">
                                                    ...
                                                    >
                                                        <span class="txt">每周一和周三 00:00</span>
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="dropdown-item closable"
                                                    ...
                                                    >
                                                        <span class="txt">每月第一天 00:00</span>
                                                    </button>
                                                </Toggler>
                                            </button>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <Field
                                        ...
                                        let:uniqueId
                                    >
                                        <label for={uniqueId}>最多保留自动备份数量</label>
                                        <input
                                            type="number"
                                            id={uniqueId}
                                            min="1"
